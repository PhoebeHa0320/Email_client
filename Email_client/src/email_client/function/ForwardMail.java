...
public class ForwardMail {
    ...
    public ForwardMail(Session sess) {
        this.sess = sess;
    }

    public void forwardEmail(String[] listTo, String[] listCC, String[] listBcc, String content, String FileName, String subject, String from) {
        ...
        setSubject(mimeMss, "Fwd: " + subject);
